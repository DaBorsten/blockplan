  ...
  return (
    <main className="p-6 mx-auto max-w-3xl space-y-6">
      <article className="prose dark:prose-invert">
        ...
        <p>
          Impressum:{" "}
          <a href="https://www.bs1-blockplan.de/impressum" target="_blank">
            https://www.bs1-blockplan.de/impressum
          </a>
        </p>
        ...
        <p>
          ...
          verwendeten Begriffe &bdquo;Bearbeitung&ldquo; von
          &bdquo;Personendaten&ldquo;, &bdquo;überwiegendes Interesse&ldquo; und
          &bdquo;besonders schützenswerte Personendaten&ldquo; werden die in der
          DSGVO verwendeten Begriffe &bdquo;Verarbeitung&ldquo; von
          &bdquo;personenbezogenen Daten&ldquo; sowie &bdquo;berechtigtes
          Interesse&ldquo; und &bdquo;besondere Kategorien von Daten&ldquo;
        ...
        <ul>
          ...
          <li>
            ...
            Angaben im Abschnitt &bdquo;Allgemeine Informationen zur
            Datenspeicherung und Löschung&ldquo;.
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            entsprechenden Serveranbieter (auch &bdquo;Webhoster&ldquo; genannt)
        ...
        <p>
          Unter dem Begriff &bdquo;Cookies&ldquo; werden Funktionen, die
          ...
          Wir verwenden Cookies gemäß den gesetzlichen Vorschriften. Dazu holen
          wir, wenn erforderlich, vorab die Zustimmung der Nutzer ein. Ist eine
          Zustimmung nicht notwendig, setzen wir auf unsere berechtigten
          Interessen. Dies gilt, wenn das Speichern und Auslesen von
          Informationen unerlässlich ist, um ausdrücklich angeforderte Inhalte
          und Funktionen bereitstellen zu können. Dazu zählen etwa die
          Speicherung von Einstellungen sowie die Sicherstellung der
          Funktionalität und Sicherheit unseres Onlineangebots. Die Einwilligung
          kann jederzeit widerrufen werden. Wir informieren klar über deren
