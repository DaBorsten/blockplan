...
function AccordionContent({
  ...
  return (
    <AccordionPrimitive.Panel
      ...
      className="text-sm overflow-hidden will-change-[height] h-(--accordion-panel-height) data-ending-style:h-0 data-starting-style:h-0 transition-[height] duration-200 ease-out"
      {...props}
    >
      <div
        className={cn(
